<%-- 
    Document   : Principal_Nivel2
    Created on : 20/05/2022, 11:43:34 AM
    Author     : LAURA
--%>
...
<!DOCTYPE html>
<%
if (session.getAttribute("nivel2") != null){
...
<html>
    <head>
        ...
        <link href="Css/Principal2_Estilo.css" rel="stylesheet" type="text/css"/>
        <%-- Fuente de letra--%>
                    ...
                    <div class="funciones">
                        <a href="Quienes_Somos.jsp"><img src="Imagen/Quienes_somos.png" alt=""/>
                            ...
                            <div class="descripcion">
                                <p>Encontraras la Mision, Vision,y Politicas. <br>
