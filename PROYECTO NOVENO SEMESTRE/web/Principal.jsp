<%-- 
    Document   : Principal
    Created on : 12/05/2022, 10:20:10 AM
    Author     : LAURA
--%>
...
<%
if (session.getAttribute("nivel4") != null){
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <link href="Css/Principal_Estilo.css" rel="stylesheet" type="text/css"/>
        <%-- Fuente de letra--%>
    ...
    <body>
        <div class="hero">
            ...
            <div class="contenedor">
                ...
                <div class="cuadro">
                    <div class="funciones">
                        <a href="Crud_Auditor.jsp"><img src="Imagen/Auditor.png" alt=""/>
                            <div class="titulo">
                                <h4><b>Auditores</b></h4>
                            </div>
                            <div class="descripcion">
                                <p>CRUD con respecto a los auditores<br>
